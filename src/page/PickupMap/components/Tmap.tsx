...
export default function Tmap() {
  ...
  useEffect(() => {
    ...
    addMarker(127.02810900563199, 37.519892712436906, 1);
    addMarker(127.11971717230388, 37.49288934463672, 2);
    addMarker(127.149560, 36.800312, 3);
    addMarker(127.150076, 36.801178, 4);
    addMarker(127.150254, 36.801264, 5);
